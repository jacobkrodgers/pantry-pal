...
import PantryShoppingListWrapper from '../Pantry/PantryShoppingListWrapper';
...
export default function SideBar({ user, children }: SideBarProps) {
    ...
    p: 4,
    borderRadius: 2,
    minWidth: 800,  // Ensure the modal has a minimum width
    maxWidth: 800,  // Optionally limit the maximum width
}}>
    <PantryShoppingListWrapper pantryItems={pantry} shoppingListItems={shoppingList}/>
</Box>
