...
export default function ShoppingList({ shoppingListItems }: ShoppingListProps) {
    const [currentShoppingListItems, setCurrentShoppingListItems] = useState(shoppingListItems); // Manage the state for ingredients
    ...
    const handleDelete = (event: React.MouseEvent, id: string) => {
        ...
        setCurrentShoppingListItems(prevIngredients => prevIngredients.filter(ingredient => ingredient.id !== id)); // Remove ingredient by id
    };
    ...
    const handleAdd = () => {
        ...
        if (form) {
            ...
            setCurrentShoppingListItems(prevIngredients => [...prevIngredients, newIngredient]);
    ...
    return (
        <>
            ...
            <Box>
                ...
                <List>
                    {currentShoppingListItems.map((ingredient) => (
                        <Box key={ingredient.id} sx={{ mb: 2, position: 'relative' }}>
                            {/* Accordion Component */}
